...
public class ViewSettingsHeaderItemDecoration extends RecyclerView.ItemDecoration {

    private ViewSettingsStickyHeaderListener mListener;
    private Integer mHeaderHeight;

    public ViewSettingsHeaderItemDecoration(ViewSettingsStickyHeaderListener listener) {
...
//        }
    ...
    private void drawHeader(Canvas c, View header,RecyclerView parent) {
        c.save();
        c.translate(0, parent.findViewHolderForAdapterPosition(0).itemView.getHeight());
        header.draw(c);
        c.restore();
    }
